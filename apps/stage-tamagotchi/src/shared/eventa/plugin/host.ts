...
export const electronPluginOpenRoot = defineInvokeEventa<{ path: string }>('eventa:invoke:electron:plugins:open-root')
export const electronPluginAddFromDirectory = defineInvokeEventa<PluginRegistrySnapshot>('eventa:invoke:electron:plugins:add-from-directory')
export const electronPluginRemove = defineInvokeEventa<PluginRegistrySnapshot, { name: string }>('eventa:invoke:electron:plugins:remove')
