...
import { electronCenterMainWindow, electronOpenChat, electronOpenMainDevtools, electronOpenMinecraftMcpMonitor, electronOpenMiniChat, electronOpenSettings, noticeWindowEventa } from '../../../../shared/eventa'
...
export async function setupMainWindowElectronInvokes(params: {
  ...
  await setupBaseWindowElectronInvokes({ context, window: params.window, serverChannel: params.serverChannel, i18n: params.i18n, mcpStdioManager: params.mcpStdioManager })
